...
# 1. Primeras filas, primeras columnas
print("\n--- 1. Primeras filas, primeras columnas ---")
print(df.iloc[:5, :3])
...
# 4. Columna por posición
print("\n--- 4. Columna por posición ---")
print(df.iloc[:, 5])

# 5. Filas intercaladas
print("\n--- 5. Filas intercaladas ---")
print(df.iloc[::2, :2])
...
# 7. Fila específica completa
print("\n--- 7. Fila específica completa ---")
print(df.iloc[24])

# 8. Rango inverso
print("\n--- 8. Rango inverso ---")
print(df.iloc[49:44:-1, :3])

# 9. Selección dispersa
print("\n--- 9. Selección dispersa ---")
print(df.iloc[[0, 10, 20, 30, 40], [0, 3, 5]])

# 10. Últimas 10 filas, columnas pares
print("\n--- 10. Últimas 10 filas, columnas pares ---")
print(df.iloc[-10:, ::2]) 
